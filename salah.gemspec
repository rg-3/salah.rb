...
The library is implemented by making HTTP requests to the PrayerDates.date web API in order
to obtain the prayer times. The PrayerDates.date web API is free to use.
DESCRIPTION
